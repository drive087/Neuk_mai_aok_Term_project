...
import AlreadyApplyJobCardModal from "./AlreadyApplyJobCardModal";

const AlreadyApplyJobForm = ({ job }) => {
      ...
      <div>
        ...
        >
          <Grid item md={12}>
            ...
            <AlreadyApplyJobCardModal job={job} />
          </Grid>
        </Grid>
      </div>
    </Card>
...
export default withRouter(AlreadyApplyJobForm);
